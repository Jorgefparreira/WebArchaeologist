export const personalProjects = [
  {
    ...
    description:
      "A fully working e-commerce website for handcrafted keyrings, based on React."
  },
  {
    id: 2,
    title: "Moss and Bark",
  ...
  // {
  // id: 5,
  // title:"VOLT™ Bikes Adwords Ad",
  // anchor:"/voltAd#works",
  // image:"voltAd",
  // gitLink:"",
  // description:"Dynamic Google Adwords ad for the VOLT™ Alpine ebike, created using Google Web Designer."
  // }
];
